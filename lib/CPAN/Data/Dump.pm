...
sub dump
{
    ...
    require CPAN::Data::Dump::FilterContext if @FILTERS;
...
sub dumpf {
    require CPAN::Data::Dump::Filtered;
    goto &CPAN::Data::Dump::Filtered::dump_filtered;
}
...
sub _dump
{
	...
	my $ctx = CPAN::Data::Dump::FilterContext->new($rval, $class, $type, $ref, $pclass, $pidx, $idx);
	my @bless;
