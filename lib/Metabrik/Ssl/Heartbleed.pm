...
# ssl::heartbleed Brik
#
package Metabrik::Ssl::Heartbleed;
use strict;
use warnings;
...
sub brik_properties {
   return {
      ...
      commands => {
         command1 => [ qw() ],
         command2 => [ qw($value_list value_type) ],
      },
      require_modules => {
...
https://raw.githubusercontent.com/noxxi/p5-scripts/master/check-ssl-heartbleed.pl
#!/usr/bin/perl
...
Metabrik::Ssl::Heartbleed - ssl::heartbleed Brik
