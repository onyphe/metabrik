...
## Packaged programs
##
#RUN apt-get install -y libssl-dev phantomjs rng-tools tcptraceroute nmap python wget unzip aptitude mysql-client scrot dsniff libmagic-dev scalpel dcfldd clamav exif volatility
##
## Packaged Perl modules
##
